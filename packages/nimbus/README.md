...
supersedes the initial local `nimbus-rpm` draft. No hosted COPR project has
been created by this workflow.

## Intended COPR project
...
That asset is not available yet. Prepare it outside the source checkout.
Preserve LICENSE,
...
license expression against the final source archive before publishing.
