...
| [github-copilot-installer](packages/github-copilot-installer/README.md) | Install and update the official Copilot RPM |
| [wowup-cf-installer](packages/wowup-cf-installer/README.md) | Install and update the official WoWUp CurseForge AppImage |

Installer helpers do not bundle or automatically install their applications.
